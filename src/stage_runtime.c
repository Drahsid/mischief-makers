...
extern u16* D_800D19A8[];
extern u16* D_800D19B8[];
...
u8 D_800D28D0[] = { // indexes of Festival Games Scenes.
    0x12, 0x12, 0x12, 0x11, 0x10, 0x12, 0x12, 0x0F, 0x11, 0x11,
...
s16 D_800D2924 = 0;
s32 gStageTimer = 0;
s32 gTransitionPortraitIndex = 0;
s32 D_800D2930 = 0;
s32 D_800D2934 = 0;
s32 gTransitionState = 0; // state of transition effect
s32 D_800D293C = 0;
s32 gTransitionTimer = 0;
s32 D_800D2944 = 0; // offset for exit transition random portraits. always 0.
s32 D_800D2948 = 0;
u16 D_800D294C = 0;
u16 gGuestActorIndex = 0;
u16 D_800D2954 = 0;
s16 gNoHit = -1;
u16 D_800D295C = 0;
u16 D_800D2960 = 0;
u16 D_800D2964 = 0;
u16 D_800D2968 = 0xFFFF;
u16 D_800D296C = 0;
s16 D_800D2970 = 0;
u16 D_800D2974 = 0;
u16 D_800D2978[1538] = { 0 };
u16 D_800D357C[80] = { 0 };
u16 D_800D361C[96] = { 0 };
u16 D_800D36DC[16] = { 0 };

u16 D_800D36FC[] = { // list of actor indexes used in Actor_UpdateNearest
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0031, 0x0041, 0x0000, 0x0902, 0xFF00, 0xFF00, 0x0000,
    0xFF00, 0x0000,
};

u16 D_800D3730[] = { 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F, 0x0040, 0x0000 };
u16 D_800D3740[] = { 0x0001, 0x0002, 0x0003, 0x0002 };
u16 D_800D3748[] = { 0x0007, 0x0008, 0x0009, 0x0008 };
u16 D_800D3750[] = { 0x0004, 0x0005, 0x0006, 0x0005 };
u16 D_800D3758[] = { 0x000A, 0x000B, 0x000C, 0x000B };
u16 D_800D3760[] = { 0x000F, 0x000E, 0x000D, 0x000E };
u16 D_800D3768[] = { 0x0012, 0x0011, 0x0010, 0x0011 };
u16 D_800D3770[] = { 0x0029, 0x002A, 0x002B, 0x002A };
u16 D_800D3778[] = { 0x0026, 0x0027, 0x0028, 0x0027 };
u16 D_800D3780[] = { 0x0013, 0x0014, 0x0015, 0x0014 };
u16 D_800D3788[] = { 0x0016, 0x0017, 0x0018, 0x0017 };
u16 D_800D3790[] = { 0x001B, 0x001A, 0x0019, 0x001A };
u16 D_800D3798[] = { 0x001E, 0x001D, 0x001C, 0x001D };
u16 D_800D37A0 = 0;
u16 D_800D37A4 = 0;
u16 D_800D37A8 = 0;
s32 D_800D37AC[] = { FIXED_UNIT(64.0), FIXED_UNIT(80.0), FIXED_UNIT(64.0), FIXED_UNIT(48.0) };
...
FuncVoidVoid D_800D37BC[] = {
    func_80044360, func_80044390, func_80044468, func_80044540,
    func_80044618, func_800446F0, func_800447AC, func_80044884,
    func_8004495C, func_80044360, func_80044360, func_80044360,
    func_800449A8, func_80044A38, func_80044A84, func_80044B00,
    func_80044360, func_80044B7C, func_80044BD8, func_80044C34,
    func_80044C90, func_80044CEC, func_80044D48, func_80044DA4,
    func_80044DEC, func_80044E34, func_80044E7C, func_80044EC4,
    func_80044F0C, func_80044F54, func_80044F9C, func_80044FE4,
    func_8004502C, func_80044DA4, func_80044DEC, func_80044E34,
    func_80044E7C, func_80044EC4, func_80044F0C, func_80044F54,
    func_80044F9C, func_80044FE4, func_8004502C, func_80045074,
    func_800450D0, func_8004512C, func_80045188, func_80045074,
    func_800450D0, func_8004512C, func_80045188,
};

u16 D_800D3888[] = {
    0xFFFF, 0xFFFB, 0xFFF5, 0xFFE5, 0xFF91, 0xFF05, 0xFFFF, 0xF7FD,
    0xFFA0, 0xFFA0, 0x0090, 0x0060, 0xFF70, 0xFFA0, 0x0090, 0x0030,
    0xFF70, 0xFFD0, 0x0090, 0x0000, 0xFF70, 0x0000, 0x0090, 0xFFD0,
    0xFF70, 0x0030, 0x0060, 0xFFD0, 0xFFA0, 0x0030, 0x0030, 0xFFD0,
    0xFFD0, 0x0030, 0x0000, 0xFFD0, 0x0000, 0x0030, 0xFFD0, 0xFFD0,
    0x0030, 0x0030, 0xFFA0, 0xFFD0, 0x0060, 0x0030, 0xFFA0, 0x0000,
    0x0060, 0x0000, 0xFFD0, 0x0000, 0x0030, 0x0000, 0x0000, 0x0000,
};

s16 gExitPortraitGraphics[] = { // collection of random portraits for exit transition.
    0x01F4, 0x01F4, 0x01F6, 0x01F8, 0x01FA, 0x01FC, 0x01FE, 0x0200,
    0x0202, 0x0204, 0x0206, 0x0208, 0x020A, 0x020C, 0x020E, 0x0210,
    0x0212, 0x0214, 0x0216, 0x0218, 0x021A, 0x021C, 0x021E, 0x0220,
    0x0222, 0x0224, 0x0226, 0x0228, 0x022A, 0x022C, 0x022E, 0x0230,
    0x01F4, 0x01F4, 0x01F6, 0x01F8, 0x01FA, 0x01FC, 0x01FE, 0x0200,
    0x0202, 0x0204, 0x0206, 0x0208, 0x020A, 0x020C, 0x020E, 0x0210,
    0x0212, 0x0214, 0x0216, 0x0218, 0x021A, 0x021C, 0x021E, 0x0220,
    0x0222, 0x0224, 0x0226, 0x0228, 0x022A, 0x022C, 0x022E, 0x0230,
    0xFF05, 0xFF05, 0x0000, 0x0000, 0xFF05, 0x0000,
};
...
uintptr_t D_800D3B78[] = {
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[8], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[9],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[8], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[9],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[10], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[8],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[9], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[8],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[9], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[10],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[11], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[12],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[13], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[14],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[15], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[16],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[17], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[18],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[19], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[20],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7],
    ...
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[0],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[1], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[2],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[3], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[4],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[5], (uintptr_t)&OVERLAY4_DISPATCH_UPTR[6],
    (uintptr_t)&OVERLAY4_DISPATCH_UPTR[7],
    (uintptr_t)func_80047994, (uintptr_t)func_80047994,
    (uintptr_t)func_80047A14, (uintptr_t)func_80047A54,
    (uintptr_t)func_80047AC4, (uintptr_t)func_80047B68,
    (uintptr_t)func_80047C28, NULL, NULL,
};
...
#define D_80202E90 ((u16*)(SEGMENT_06_DEST + 0x2A90))
#define D_80202C90 PALETTE_80202C90
#define D_802119B8 ((u16*)(SEGMENT_06_DEST + 0x115B8))
#define D_8024506A ((u16*)(SEGMENT_06_DEST + 0x44C6A))
#define D_80245E48 ((u16*)(SEGMENT_06_DEST + 0x45A48))
#define D_80246C48 ((u16*)(SEGMENT_06_DEST + 0x46848))
#define D_80247A70 ((u16*)(SEGMENT_06_DEST + 0x47670))
#define D_80250FD2 ((u16*)(SEGMENT_06_DEST + 0x50BD2))
#define D_80362700 ((u16*)(ASSET_DEST5 + 0x2700))
#define D_80372500 ((u16*)(ASSET_DEST5 + 0x12500))
#define D_803023B4 ((u16*)(ASSET_DEST2 + 0x23B4))
...
void func_8004495C(void) {
    ...
    gStaticObjects[D_801782C0].palette = PALETTE_80203440;
}
...
void func_80044A38(void) {
    ...
    gStaticObjects[D_801782C0].palette = PALETTE_80203240;
}

void func_80044A84(void) {
    gStaticObjects[D_801782C0].graphicIndex = 0x24;
    gStaticObjects[D_801782C0].palette = PALETTE_80203050;
