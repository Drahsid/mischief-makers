...
#include "linker.h"
#include "rle.h"
#include "render_setup_data.h"

// TODO: can this be refactored with gbi.h?
// appears to be intentionally clipping 1 texel per pixel?
...
u8* D_800C5C90[] = { // array of dst pointers for RLE
    ACTOR_GRAPHICS_CACHE_DEST + 0x0000, ACTOR_GRAPHICS_CACHE_DEST + 0x0900,
    ACTOR_GRAPHICS_CACHE_DEST + 0x1200, ACTOR_GRAPHICS_CACHE_DEST + 0x1B00,
    ACTOR_GRAPHICS_CACHE_DEST + 0x2400, ACTOR_GRAPHICS_CACHE_DEST + 0x2D00,
    ACTOR_GRAPHICS_CACHE_DEST + 0x3600, ACTOR_GRAPHICS_CACHE_DEST + 0x3F00,
    ACTOR_GRAPHICS_CACHE_DEST + 0x4800, ACTOR_GRAPHICS_CACHE_DEST + 0x5100,
    ACTOR_GRAPHICS_CACHE_DEST + 0x5A00, ACTOR_GRAPHICS_CACHE_DEST + 0x6300,
    ACTOR_GRAPHICS_CACHE_DEST + 0x6C00, ACTOR_GRAPHICS_CACHE_DEST + 0x7500,
    ACTOR_GRAPHICS_CACHE_DEST + 0x7E00, ACTOR_GRAPHICS_CACHE_DEST + 0x8700
};

u8* D_800C5CD0[] = { // array of dst pointers for RLE
    ACTOR_GRAPHICS_CACHE_DEST + 0x9000, ACTOR_GRAPHICS_CACHE_DEST + 0x9900,
    ACTOR_GRAPHICS_CACHE_DEST + 0xA200, ACTOR_GRAPHICS_CACHE_DEST + 0xAB00,
    ACTOR_GRAPHICS_CACHE_DEST + 0xB400, ACTOR_GRAPHICS_CACHE_DEST + 0xBD00,
    ACTOR_GRAPHICS_CACHE_DEST + 0xC600, ACTOR_GRAPHICS_CACHE_DEST + 0xCF00,
    ACTOR_GRAPHICS_CACHE_DEST + 0xD800, ACTOR_GRAPHICS_CACHE_DEST + 0xE100,
    ACTOR_GRAPHICS_CACHE_DEST + 0xEA00, ACTOR_GRAPHICS_CACHE_DEST + 0xF300,
    ACTOR_GRAPHICS_CACHE_DEST + 0xFC00, ACTOR_GRAPHICS_CACHE_DEST + 0x10500,
    ACTOR_GRAPHICS_CACHE_DEST + 0x10E00, ACTOR_GRAPHICS_CACHE_DEST + 0x11700,
    (u8*)D_800C5608
};
...
u8* D_800C5F20[] = {
    SEGMENT_06_DEST + 0x3520, SEGMENT_06_DEST + 0x3A20, SEGMENT_06_DEST + 0x3F20,
    SEGMENT_06_DEST + 0x4420, SEGMENT_06_DEST + 0x46A0, SEGMENT_06_DEST + 0x4920,
    SEGMENT_06_DEST + 0x4BA0, SEGMENT_06_DEST + 0x4EA0, SEGMENT_06_DEST + 0x51A0,
    SEGMENT_06_DEST + 0x54A0, SEGMENT_06_DEST + 0x5620, SEGMENT_06_DEST + 0x57A0,
    SEGMENT_06_DEST + 0x5920, SEGMENT_06_DEST + 0x5E20, SEGMENT_06_DEST + 0x6320,
    SEGMENT_06_DEST + 0x6820, SEGMENT_06_DEST + 0x69A0, SEGMENT_06_DEST + 0x6B20,
    SEGMENT_06_DEST + 0x6CA0, SEGMENT_06_DEST + 0x71A0, SEGMENT_06_DEST + 0x76A0,
    SEGMENT_06_DEST + 0x7BA0, SEGMENT_06_DEST + 0x80A0, SEGMENT_06_DEST + 0x85A0,
    SEGMENT_06_DEST + 0x8AA0, SEGMENT_06_DEST + 0x8DA0, SEGMENT_06_DEST + 0x90A0,
    SEGMENT_06_DEST + 0x93A0, SEGMENT_06_DEST + 0x96A0, SEGMENT_06_DEST + 0x99A0,
    SEGMENT_06_DEST + 0x9CA0, SEGMENT_06_DEST + 0xA0A0, SEGMENT_06_DEST + 0xAB20,
    SEGMENT_06_DEST + 0xAF20, SEGMENT_06_DEST + 0xB320, SEGMENT_06_DEST + 0xB720,
    SEGMENT_06_DEST + 0xBD60, SEGMENT_06_DEST + 0xC3A0, SEGMENT_06_DEST + 0xC6A0,
    SEGMENT_06_DEST + 0xC9A0, SEGMENT_06_DEST + 0xCCA0, SEGMENT_06_DEST + 0xD0A0,
    SEGMENT_06_DEST + 0xD4A0, SEGMENT_06_DEST + 0xD8A0, SEGMENT_06_DEST + 0xDCA0,
    SEGMENT_06_DEST + 0xE0A0, SEGMENT_06_DEST + 0xE4A0, SEGMENT_06_DEST + 0xE5A0,
    SEGMENT_06_DEST + 0xE6A0, SEGMENT_06_DEST + 0xE7A0, SEGMENT_06_DEST + 0xE8A0,
    SEGMENT_06_DEST + 0xE9A0, SEGMENT_06_DEST + 0xEAA0, SEGMENT_06_DEST + 0xEEA0,
    SEGMENT_06_DEST + 0xF2A0, SEGMENT_06_DEST + 0xF6A0, NULL,
    SEGMENT_06_DEST + 0xFC20, SEGMENT_06_DEST + 0xFDA0, SEGMENT_06_DEST + 0xFF20,
    SEGMENT_06_DEST + 0x100A0, SEGMENT_06_DEST + 0x10220, SEGMENT_06_DEST + 0x103A0,
    SEGMENT_06_DEST + 0x10520
};

s16 gActorsBack[128];
s16 gActorsMiddle[128];
s16 gActorsFront[240];
s16 gActorsTop[240];
...
#define D_80200FA8 ((Vtx*)(SEGMENT_06_DEST + 0xBA8))
#define D_802447E8 (SEGMENT_06_DEST + 0x443E8)
#define D_802688F8 ((u16**)(SEGMENT_06_SCRATCH + 0xB38))

#define D_8020FB60 (SEGMENT_06_DEST + 0xF760) // array of texture images
#define D_8021F9E0 (SEGMENT_06_DEST + 0x1F5E0) // texture image
#define D_802201E0 (SEGMENT_06_DEST + 0x1FDE0) // texture image
#define D_802209E0 (SEGMENT_06_DEST + 0x205E0) // texture palette
#define D_80222220 (SEGMENT_06_DEST + 0x21E20) // texture palette

#define D_802DB888 ((u8**)(ASSET_DEST0 + 0x11388))
#define D_802EB278 ((u8**)(ASSET_DEST1 + 0xB278))
#define D_802F93B8 ((u8**)(ASSET_DEST1 + 0x193B8))
#define D_80310D00 ((u8**)(ASSET_DEST2 + 0x10D00))
#define D_80317F48 ((u8**)(ASSET_DEST2 + 0x17F48))
#define D_8032F940 ((u8**)(ASSET_DEST3 + 0xF940))
#define D_80338810 ((u8**)(ASSET_DEST3 + 0x18810))
#define D_803440C8 ((u8**)(ASSET_DEST4 + 0x40C8))
#define D_80350AD8 ((u8**)(ASSET_DEST4 + 0x10AD8))

#define D_80202688 ((u16*)(SEGMENT_06_DEST + 0x2288)) // palette
#define D_80202888 ((u16*)(SEGMENT_06_DEST + 0x2488)) // palette
#define D_80202A88 ((u16*)(SEGMENT_06_DEST + 0x2688)) // palette

#define D_8024B5E8 (SEGMENT_06_DEST + 0x4B1E8)
#define D_8024B628 (SEGMENT_06_DEST + 0x4B228)

#define D_802651E8 ((u16*)(GRAPHICS_PALETTE_BUFFER_VRAM - 0x10)) // palette

#define D_8027D2E8 (TEXT_CANVAS_256X64_CI4_VRAM + 0x400) // casts break matching
#define D_8027F2E8 (TEXT_CANVAS_256X48_CI4_VRAM + 0x400) // casts break matching

// RLE dst pointers
#define D_802CA8F8 (ASSET_DEST0 + 0x3F8)
#define D_802CAA90 (ASSET_DEST0 + 0x590)
#define D_802CCCF8 (ASSET_DEST0 + 0x27F8)
#define D_802CCE90 (ASSET_DEST0 + 0x2990)
#define D_802CF290 (ASSET_DEST0 + 0x4D90)
#define D_802D1690 (ASSET_DEST0 + 0x7190)
#define D_802E03A0 (ASSET_DEST1 + 0x3A0)
#define D_802E03F0 (ASSET_DEST1 + 0x3F0)
#define D_802E27A0 (ASSET_DEST1 + 0x27A0)
#define D_802E27F0 (ASSET_DEST1 + 0x27F0)
#define D_802E4BF0 (ASSET_DEST1 + 0x4BF0)
#define D_802E6FF0 (ASSET_DEST1 + 0x6FF0)
#define D_803003F0 (ASSET_DEST2 + 0x3F0)
#define D_803027F0 (ASSET_DEST2 + 0x27F0)
#define D_80320250 (ASSET_DEST3 + 0x250)
#define D_803203F0 (ASSET_DEST3 + 0x3F0)
#define D_803205B0 (ASSET_DEST3 + 0x5B0)
#define D_80320748 (ASSET_DEST3 + 0x748)
#define D_80321B50 (ASSET_DEST3 + 0x1B50)
#define D_803227F0 (ASSET_DEST3 + 0x27F0)
#define D_803229B0 (ASSET_DEST3 + 0x29B0)
#define D_80322B48 (ASSET_DEST3 + 0x2B48)
#define D_80324BF0 (ASSET_DEST3 + 0x4BF0)
#define D_80324DB0 (ASSET_DEST3 + 0x4DB0)
#define D_80324F48 (ASSET_DEST3 + 0x4F48)
#define D_80326FF0 (ASSET_DEST3 + 0x6FF0)
#define D_803271B0 (ASSET_DEST3 + 0x71B0)
#define D_80327348 (ASSET_DEST3 + 0x7348)
    ...
    for (index = 0; index < temp_v0; index++) {
        ...
        if (gActors[actor_index].flags & ACTOR_FLAG_UNK28) {
            ...
            if (gActors[actor_index].flags & ACTOR_FLAG_UNK30) {
                gDPLoadTLUT_pal16(gDisplayListHead++, 0, GRAPHICS_PALETTE_BUFFER_VRAM);
                ...
                if (gActors[actor_index].flags & ACTOR_FLAG_UNK29) {
                    ...
                    for (index_x = 0; index_x < 4; index_x++) {
                        gDPLoadTextureBlock_4b(gDisplayListHead++, TEXT_CANVAS_256X64_CI4_VRAM + index_x * 0x800, G_IM_FMT_CI, 128, 16, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
                    ...
                    for (index_x = 0; index_x < 3; index_x++) {
                        gDPLoadTextureBlock_4b(gDisplayListHead++, TEXT_CANVAS_256X48_CI4_VRAM + index_x * 0x800, G_IM_FMT_CI, 128, 16, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
                        gSPTextureRectangle(gDisplayListHead++, xl << 2, yl << 2, xh << 2, yh << 2, 0, 0, 0, 0x1000, 0x400);
