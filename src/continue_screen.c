...
// "Continue !!!!"
u16 gStrContinue1[] = {
    ALPHA_EN3_UPPER_C, ALPHA_EN3_LOWER_O, ALPHA_EN3_LOWER_N, ALPHA_EN3_LOWER_T, ALPHA_EN3_LOWER_I, ALPHA_EN3_LOWER_N, ALPHA_EN3_LOWER_U, ALPHA_EN3_LOWER_E, ALPHA_SPACE,
    ALPHA_EXCLAMATION, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION,
    ALPHA_NULL
};
...
u16 gStrContinue2[] = {
    ...
    ALPHA_EXCLAMATION, ALPHA_EXCLAMATION,
    ALPHA_NULL
};
...
u16 gStrContinue3[] = {
    ALPHA_EN3_UPPER_C, ALPHA_EN3_LOWER_O, ALPHA_EN3_LOWER_N, ALPHA_EN3_LOWER_T, ALPHA_EN3_LOWER_I, ALPHA_EN3_LOWER_N, ALPHA_EN3_LOWER_U, ALPHA_EN3_LOWER_E, ALPHA_SPACE,
    ALPHA_EN3_UPPER_N, ALPHA_EN3_LOWER_O, ALPHA_EN3_LOWER_W, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION,
    ALPHA_NULL
};
...
u16 gStrContinue5[] = {
    ...
    ALPHA_EXCLAMATION, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION, ALPHA_EXCLAMATION,
    ALPHA_NULL
};

// "Getting Close!"
u16 gStrContinue6[] = {
    ALPHA_EN3_UPPER_G, ALPHA_EN3_LOWER_E, ALPHA_EN3_LOWER_T, ALPHA_EN3_LOWER_T, ALPHA_EN3_LOWER_I, ALPHA_EN3_LOWER_N, ALPHA_EN3_LOWER_G, ALPHA_SPACE,
    ALPHA_EN3_UPPER_C, ALPHA_EN3_LOWER_L, ALPHA_EN3_LOWER_O, ALPHA_EN3_LOWER_S, ALPHA_EN3_LOWER_E,
    ALPHA_EXCLAMATION,
    ALPHA_NULL
};
...
u16 gStrGameOver[] = {
    ...
    ALPHA_ELLIPSIS, ALPHA_EN3_UPPER_R,
    ALPHA_NULL
};
...
u16 gStrContinueDesc100[] = {
    ...
    ALPHA_EN2_UPPER_M, ALPHA_EN2_LOWER_A, ALPHA_EN2_LOWER_X, ALPHA_SPACE,
    ALPHA_EN2_UPPER_P, ALPHA_EN2_LOWER_O, ALPHA_EN2_LOWER_W, ALPHA_EN2_LOWER_E, ALPHA_EN2_LOWER_R, ALPHA_SPACE,
...
u16 gStrContinueDesc30[] = {
    ALPHA_SPACE, ALPHA_SPACE,
    ALPHA_EN2_UPPER_L, ALPHA_EN2_LOWER_I, ALPHA_EN2_LOWER_F, ALPHA_EN2_LOWER_E, ALPHA_SPACE,
    ALPHA_EN2_UPPER_U, ALPHA_EN2_LOWER_P, ALPHA_SPACE,
    ALPHA_EN2_UPPER_C, ALPHA_EN2_LOWER_O, ALPHA_EN2_LOWER_N, ALPHA_EN2_LOWER_T, ALPHA_EN2_LOWER_I, ALPHA_EN2_LOWER_N, ALPHA_EN2_LOWER_U, ALPHA_EN2_LOWER_E,
    ALPHA_NULL
};
...
u16 gStrContinueDesc10[] = {
    ALPHA_SPACE, ALPHA_SPACE,
    ALPHA_EN2_UPPER_N, ALPHA_EN2_LOWER_O, ALPHA_EN2_LOWER_R, ALPHA_EN2_LOWER_M, ALPHA_EN2_LOWER_A, ALPHA_EN2_LOWER_L, ALPHA_SPACE,
    ALPHA_EN2_UPPER_C, ALPHA_EN2_LOWER_O, ALPHA_EN2_LOWER_N, ALPHA_EN2_LOWER_T, ALPHA_EN2_LOWER_I, ALPHA_EN2_LOWER_N, ALPHA_EN2_LOWER_U, ALPHA_EN2_LOWER_E,
    ALPHA_NULL
};
...
u16 gStrContinueDesc0[] = {
    ALPHA_SPACE, ALPHA_SPACE,
    ALPHA_EN2_UPPER_I, ALPHA_EN2_APOSTROPHE, ALPHA_EN2_LOWER_M, ALPHA_SPACE,
    ALPHA_EN2_UPPER_D, ALPHA_EN2_LOWER_O, ALPHA_EN2_LOWER_N, ALPHA_EN2_LOWER_E,
    ALPHA_NULL
};
...
void GameState_ContinueScreen(void) {
    ...
    case 2:
        ...
        if (gContinueTimer == 3000) {
            ...
            D_80178142 = -0x1F;
            Palette_AdjustRgb5551Array(gStrContinuePalette, (u16* )GRAPHICS_PALETTE_BUFFER_VRAM, 8, D_80178142, D_80178142, D_80178142);
            func_80083454();
        ...
        for (actor_index = 0x41; actor_index < 0x4B; actor_index++) {
            ...
            for (actor_0 = actor_index + 0x1F; actor_0 < actor_index + 0x47; actor_0 += 10) {
                if (gActors[actor_0].flags == 0) {
                    ...
                    gActors[actor_0].unk_18C = SEGMENT_06_DEST_VRAM + 0x2D128;
