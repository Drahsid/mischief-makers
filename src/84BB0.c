...
u16 D_800E3D20[] = { // indices of flower sprites.
    GINDEX_FLOWERRED, GINDEX_FLOWERDAISY, GINDEX_FLOWERTULIP,
    GINDEX_FLOWERD, GINDEX_FLOWERE, GINDEX_FLOWERF,
};

u8 D_800E3D2C[] = {
    0x01, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
    0x02, 0x01, 0x02, 0x02, 0x00, 0x01, 0x00, 0x00,
    0x02, 0x02, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
};

u16 D_800E3D4C[] = { // indices of hat sprites.
    GINDEX_HAT_COWBOY, GINDEX_HAT_SANTA, GINDEX_HAT_CELES, GINDEX_HAT_TERAN,
    GINDEX_HAT_HARD, GINDEX_HAT_USHANKA, 0x3014, GINDEX_HAT_STOVETOP,
    GINDEX_CLANBOMB, GRAPHIC_FRAME(CLANBOMB, 1), GRAPHIC_FRAME(CLANBOMB, 2), 0x0000,
};

s16 D_800E3D64[] = {
    GINDEX_CLANBOMB, 0x000C, GRAPHIC_FRAME(CLANBOMB, 1), 0x0008,
    GRAPHIC_FRAME(CLANBOMB, 2), 0x000C, GRAPHIC_FRAME(CLANBOMB, 1), 0x0008,
    0xFFF8, 0x0000,
};

s16 D_800E3D78[] = {
    GINDEX_CLANBOMB, 0x0008, GRAPHIC_FRAME(CLANBOMB, 1), 0x0004,
    GRAPHIC_FRAME(CLANBOMB, 2), 0x0008, GRAPHIC_FRAME(CLANBOMB, 1), 0x0004,
    0xFFF8, 0x0000,
};

s16 D_800E3D8C[] = {
    GINDEX_CLANBOMB, 0x0002, GRAPHIC_FRAME(CLANBOMB, 1), 0x0001,
    GRAPHIC_FRAME(CLANBOMB, 2), 0x0002, GRAPHIC_FRAME(CLANBOMB, 1), 0x0001,
    0xFFF8, 0x0000,
};

s16 D_800E3DA0[] = {
    GINDEX_POW, 0x0001, GRAPHIC_FRAME(POW, 1), 0x0001,
    GRAPHIC_FRAME(POW, 2), 0x0001, GRAPHIC_FRAME(POW, 3), 0x0001,
    GRAPHIC_FRAME(POW, 4), 0x0001, 0x0000, 0x0000,
};

u16 D_800E3DB8 = 0x000A;

f32 D_800E3DBC[] = { // scales of clanbomb.
    0.200000003f, 0.400000006f, 0.6000000238f, 0.8000000119f,
    1.0f, 1.200000048f, 1.399999976f, 3.0f,
};

s16 D_800E3DDC[] = { // clanbomb hitbox LUT
    0x0004, 0xFFF4, 0xFFF8, 0x0008,
};

s32 D_800E3DE4[] = {
    0x00040000, 0x00020000, 0x00040000, 0x00020000,
    0x00040000, 0x00020000, 0x00040000, 0x00020000,
    0x00040000, 0x00020000, 0x00040000, 0x00020000,
    0x00040000, 0x00020000, 0x00040000, 0x00020000,
};
...
s32 D_800E3E24[] = {
    0x0000003C, 0x00000000, 0x00000028, 0x00080000,
    0x0000003C, 0x00000000, 0x00000028, 0xFFF80000,
    0x0000003C, 0x00000000, 0x00000028, 0x00080000,
    0x00100000, 0x00000001, 0x0000003C, 0x00000000,
    0x00000000, 0x00100000, 0x00000000, 0x0000003C,
    0x00000000, 0x00000000, 0x00100000, 0x00000000,
    0x0000003C, 0x00000000, 0x00000000, 0x00100000,
    0x00000000, 0x0000003C, 0x00000000, 0x00000000,
    0x00100000, 0x00000000, 0x0000003C, 0x00000000,
    0x00000000, 0x00100000, 0x00000000, 0x0000003C,
    0x00000000, 0x00000000, 0x00100000, 0x00000000,
    0x0000003C, 0x00000000, 0x00000024, 0x00080000,
    0x00000001, 0x00000064, 0x00000000, 0x00000000,
    0xFFF00000, 0x00000001, 0x00000064, 0x00000000,
...
s16 D_800E42F4[] = {
    0x0284, 0x0003, 0x0286, 0x0003, 0x0288, 0x0003, 0xFFFA, 0x0000,
};

s32 D_800E4304[] = {
    0x00000045, 0x0000003B, 0x00000004, 0x00000000,
    0xFFFFFFFC,
};

s32 D_800E4318[] = {
    0x00000008, 0x00000070, 0x00000000, 0x00000000,
    0xFFFFFFFC, 0x00000045, 0x0000003B, 0x00000004,
    0x00000000, 0x00000043, 0x00000000, 0x00000000,
    0x00000000, 0x00000044, 0x00000000, 0x00000000,
    0x00000000, 0xFFFFFFF4,
};

s32 D_800E4360[] = {
    0x00000045, 0x00000010, 0x00000004, 0x00000001,
    0xFFFFFFFC,
};

s32 D_800E4374[] = {
    0x00000045, 0x0000003B, 0x00000004, 0x00000001,
    0x00000000,
};
...
s32 D_800E442C[] = {
    0x00000045, 0x00000001, 0x00000004, 0x00000001,
    0xFFFFFFFC,
};

s32* D_800E4440[] = { // LUT of digging spot actors
    D_800E4304, D_800E4318, D_800E4360, D_800E4374,
    D_800E4388, D_800E442C,
};

ActorUnk_800E44C0 D_800E4458[] = {
    { 0x59, 0, 0, 0, 0, 0x1E },
};
s32 D_800E4470 = -6;

ActorUnk_800E44C0 D_800E4474[] = {
    { 0x59, 0, 0, 0x0002D414, 0x00040000, 0x1E },
    { 0x59, 0, 0, 0, 0x00040000, 0x1E },
    { 0x59, 0, 0, 0xFFFD2BEC, 0x00040000, 0x1E },
};
s32 D_800E44BC = -0x12;

ActorUnk_800E44C0* D_800E44C0[] = {
    D_800E4458, D_800E4474,
};

s16 D_800E44C8[] = { // graphic list
    GINDEX_CLANBLOCKBARREL, 0x000A, GRAPHIC_FRAME(CLANBLOCKBARREL, 1), 0x000A,
    GRAPHIC_FRAME(CLANBLOCKBARREL, 2), 0x000A, GRAPHIC_FRAME(CLANBLOCKBARREL, 1), 0x000A,
    0xFFF8, 0x0000,
};

s16 D_800E44DC[] = { // graphic list
    GINDEX_CLANBLOCKBUCKET, 0x000A, GRAPHIC_FRAME(CLANBLOCKBUCKET, 1), 0x000A,
    GRAPHIC_FRAME(CLANBLOCKBUCKET, 2), 0x000A, GRAPHIC_FRAME(CLANBLOCKBUCKET, 1), 0x000A,
    0xFFF8, 0x0000,
};

s32 D_800E44F0[] = {
    (s32)D_800DE348, (s32)D_800DE188, (s32)D_800DE508, (s32)D_800DE6C8,
    (s32)D_800DE888, (s32)D_800DEA48, (s32)D_800DEF88, (s32)D_800DEDC8,
    (s32)D_800DEC08, (s32)D_800DF308, (s32)D_800DF148, (s32)D_800DF4C8,
    (s32)D_800DF688, (s32)D_800DDFC8, (s32)D_800DDE08, (s32)D_800DDC48,
    (s32)D_800DDA88,
};

s16 D_800E4534[] = {
    GINDEX_POOF, 0x0002, GRAPHIC_FRAME(POOF, 1), 0x0002,
    GRAPHIC_FRAME(POOF, 2), 0x0002, GRAPHIC_FRAME(POOF, 3), 0x0002,
    GRAPHIC_FRAME(POOF, 4), 0x0002, GRAPHIC_FRAME(POOF, 5), 0x0002,
    GRAPHIC_FRAME(POOF, 6), 0x0002, GRAPHIC_FRAME(POOF, 7), 0x0002,
...
// BUG: incorrect prototype! func_8001FCA0 only matches if arg1/arg2 are `s16`, but only matches below as `s32`
...
void func_80088518(u16 actor_index) {
    gActors[actor_index].var_15C = FIXED_UNIT(48.0/256);
...
void func_80088E90(u16 actor_index) {
    ...
    if (gActors[actor_index].var_150 & 0x1000) {
        // TODO?: -FROM_FIXED((f64)gActors[actor_index].velocityX.raw) * 5.371479329;
            gActors[actor_index].rotateZ += -(gActors[actor_index].velocityX.raw / (f64)FIXED_UNIT(1.0)) * 5.371479329;
    }
    else {
            gActors[actor_index].rotateZ += -(gActors[actor_index].velocityX.raw / (f64)FIXED_UNIT(1.0)) * 3.58098622;
    }
    ...
    case 1:
        if (!(gActiveFrames & 0x3F)) {
            ...
            if (particle_index != 0) {
                ...
                gActors[particle_index].velocityY.raw = FIXED_UNIT(160.0/256);
...
void func_8008BC5C(u16 actor_index) {
    ...
    if (gActors[actor_index].state >= 0x10) {
        ...
        if (gActors[actor_index].unk_164 >= 0x3D) {
            gActors[actor_index].velocityX.raw = Math_ApproachS32(gActors[actor_index].velocityX.raw, gActors[index].unk_168, FIXED_UNIT(4.0/256));
        }
        else if (gActors[actor_index].unk_164 >= 0x1F) {
            gActors[actor_index].velocityX.raw = Math_ApproachS32(gActors[actor_index].velocityX.raw, gActors[index].unk_164, FIXED_UNIT(4.0/256));
        }
        else {
            gActors[actor_index].velocityX.raw = Math_ApproachS32(gActors[actor_index].velocityX.raw, gActors[index].var_160, FIXED_UNIT(4.0/256));
        }
    }
    switch (gActors[actor_index].state) {
    case 0:
    ...
    case 1:
        ...
        gActors[actor_index].unk_164 = Math_ApproachS32(gActors[actor_index].unk_164, gActors[actor_index].var_160, FIXED_UNIT(4.0/256));
        gActors[actor_index].unk_168 = Math_ApproachS32(gActors[actor_index].unk_168, gActors[actor_index].var_160, FIXED_UNIT(4.0/256));
        break;
    case 16:
        gActors[actor_index].velocityY.raw = FIXED_UNIT(160.0/256);
