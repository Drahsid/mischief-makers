...
<<<<<<< Updated upstream
=======
/* This function looks to dma sprite data for collectibles?
 * Needs a lot of work. Behavior is similar, but there is a lot extra going on
*/
#ifdef NON_MATCHING
void func_800457C8(void) {
    ...
    phi_s0 = (gStageTimeReal & 0x1F) / 4;
    if ((gStageTimeReal & 0x20) == 0) {
        phi_s0 = 7 - phi_s0;
    }
    ...
    temp_f8 = 2.0 * phi_s0;
    switch (gStageTimeReal & 7) {
        case 0:
            func_8002B82C(&D_800D8D68, gSpriteData_YellowGem, 0x3C, temp_f8, temp_f8, temp_f8);
            func_8002B82C(&D_800DE508, &D_800DE188, 0x1C, 0, 0, temp_f8);
            break;
        case 1:
            func_8002B82C(&D_800D8DE0, &D_800D8CF0, 0x3B, temp_f8, temp_f8, temp_f8);
            func_8002B82C(&D_800DE540, &D_800DE1C0, 0x1C, 0, 0, temp_f8);
            break;
        case 2:
            func_8002B82C(&D_800D89A8, gSpriteData_RedGem, 0x3C, 0, 0, temp_f8);
            func_8002B82C(&D_800DE578, &D_800DE1F8, 0x1C, 0, 0, temp_f8);
            break;
        case 3:
            func_8002B82C(&D_800D8A20, &D_800D8930, 0x3B, 0, 0, temp_f8);
            func_8002B82C(&D_800DE5B0, &D_800DE230, 0x1C, 0, 0, temp_f8);
            break;
        case 4:
            func_8002B82C(&D_800D8B88, &D_800D8A98, 0x3C, 0, temp_f8, 0);
            func_8002B82C(&D_800DE5E8, &D_800DE268, 0x1C, 0, 0, temp_f8);
            break;
        case 5:
            func_8002B82C(&D_800D8C00, &D_800D8B10, 0x3B, 0, temp_f8, 0);
            func_8002B82C(&D_800DE620, &D_800DE2A0, 0x1C, 0, 0, temp_f8);
            break;
        case 6:
            func_8002B82C(&D_800D87C8, gSpriteData_BlueGem, 0x3C, temp_f8, 0, 0);
            func_8002B82C(&D_800DE658, &D_800DE2D8, 0x1C, 0, 0, temp_f8);
            break;
        case 7:
            func_8002B82C(&D_800D8840, &D_800D8750, 0x3B, temp_f8, 0, 0);
            func_8002B82C(&D_800DE690, &D_800DE310, 0x1C, 0, 0, temp_f8);
            break;
    }

    temp_s0 = func_800456DC();
    sp2C = func_8002B5A0(0x6001, 0, 0, temp_s0 / 2);
    temp_t7 = func_8002B5A0(0x8001, 0, 0, temp_s0);
    D_800DE1D6 = temp_t7;
    D_800D9FC4 = temp_t7;
    D_800D9CC4 = temp_t7;
    D_800D9DC4 = temp_t7;
    ...
    D_800DDAD6 = sp2C;
    D_800DE016 = sp2C;
    D_80251020 = func_8002B5A0(0x6001, 0, temp_s0, 0);
}
#else
>>>>>>> Stashed changes
