...
void MarinaGraphics_Decompress(void) {
    ...
    if (gCopiedSegment5) {
        ...
        switch (bank) {
        case 0:
            Trouble_RLE_Type2(RLE_SCRATCH_LOW, MARINA_GRAPHICS_BANK0_DEST, MARINA_GRAPHICS_BANK_SIZE);
            break;
        case 1:
            Trouble_RLE_Type2(RLE_SCRATCH_LOW, MARINA_GRAPHICS_BANK1_DEST, MARINA_GRAPHICS_BANK_SIZE);
            break;
        }
        D_800BE6A4 &= 0x7FFF;
    }
