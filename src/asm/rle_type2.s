...
glabel Trouble_RLE_Type2
    /* 99750 80098B50 00803825 */  or         $a3, $a0, $zero
    /* 99754 80098B54 00A01025 */  or         $v0, $a1, $zero
    /* 99758 80098B58 00A61820 */  add        $v1, $a1, $a2 /* handwritten instruction */
.L80098B5C:
    /* 9975C 80098B5C 90E40000 */  lbu        $a0, 0x0($a3)
    /* 99760 80098B60 20E70001 */  addi       $a3, $a3, 0x1 /* handwritten instruction */
    ...
    /* 99784 80098B84 90E80000 */  lbu        $t0, 0x0($a3)
    /* 99788 80098B88 00442020 */  add        $a0, $v0, $a0 /* handwritten instruction */
    /* 9978C 80098B8C 20E70001 */  addi       $a3, $a3, 0x1 /* handwritten instruction */
.L80098B90:
    /* 99790 80098B90 20420001 */  addi       $v0, $v0, 0x1 /* handwritten instruction */
    /* 99794 80098B94 1444FFFE */  bne        $v0, $a0, .L80098B90
    /* 99798 80098B98 A048FFFF */   sb        $t0, -0x1($v0)
...
.L80098BB0:
    ...
    /* 997B8 80098BB8 00442020 */  add        $a0, $v0, $a0 /* handwritten instruction */
.L80098BBC:
    /* 997BC 80098BBC 90E80000 */  lbu        $t0, 0x0($a3)
    /* 997C0 80098BC0 20420001 */  addi       $v0, $v0, 0x1 /* handwritten instruction */
    /* 997C4 80098BC4 20E70001 */  addi       $a3, $a3, 0x1 /* handwritten instruction */
    /* 997C8 80098BC8 1444FFFC */  bne        $v0, $a0, .L80098BBC
    /* 997CC 80098BCC A048FFFF */   sb        $t0, -0x1($v0)
...
.L80098BE4:
    ...
    /* 997EC 80098BEC 30480003 */  andi       $t0, $v0, 0x3
    /* 997F0 80098BF0 24010003 */  addiu      $at, $zero, 0x3
    /* 997F4 80098BF4 1101004E */  beq        $t0, $at, .L80098D30
    /* 997F8 80098BF8 00442020 */   add       $a0, $v0, $a0 /* handwritten instruction */
    /* 997FC 80098BFC 24010002 */  addiu      $at, $zero, 0x2
    /* 99800 80098C00 11010033 */  beq        $t0, $at, .L80098CD0
    /* 99804 80098C04 24010001 */   addiu     $at, $zero, 0x1
    /* 99808 80098C08 11010018 */  beq        $t0, $at, .L80098C6C
    /* 9980C 80098C0C 00000000 */   nop
.L80098C10:
    /* 99810 80098C10 20420040 */  addi       $v0, $v0, 0x40 /* handwritten instruction */
    ...
    /* 9984C 80098C4C AC40FFF8 */  sw         $zero, -0x8($v0)
    /* 99850 80098C50 1444FFEF */  bne        $v0, $a0, .L80098C10
    /* 99854 80098C54 AC40FFFC */   sw        $zero, -0x4($v0)
...
.L80098C6C:
    /* 9986C 80098C6C 20420040 */  addi       $v0, $v0, 0x40 /* handwritten instruction */
    ...
    /* 998AC 80098CAC AC40FFF7 */  sw         $zero, -0x9($v0)
    /* 998B0 80098CB0 AC40FFFB */  sw         $zero, -0x5($v0)
    /* 998B4 80098CB4 1444FFED */  bne        $v0, $a0, .L80098C6C
    /* 998B8 80098CB8 A040FFFF */   sb        $zero, -0x1($v0)
...
.L80098CD0:
    /* 998D0 80098CD0 20420040 */  addi       $v0, $v0, 0x40 /* handwritten instruction */
    ...
    /* 99910 80098D10 AC40FFFA */  sw         $zero, -0x6($v0)
    /* 99914 80098D14 1444FFEE */  bne        $v0, $a0, .L80098CD0
    /* 99918 80098D18 A440FFFE */   sh        $zero, -0x2($v0)
...
.L80098D30:
    /* 99930 80098D30 20420040 */  addi       $v0, $v0, 0x40 /* handwritten instruction */
    ...
    /* 99970 80098D70 AC40FFF9 */  sw         $zero, -0x7($v0)
    /* 99974 80098D74 A440FFFD */  sh         $zero, -0x3($v0)
    /* 99978 80098D78 1444FFED */  bne        $v0, $a0, .L80098D30
    /* 9997C 80098D7C A040FFFF */   sb        $zero, -0x1($v0)
...
.L80098D94:
    ...
    /* 99998 80098D98 30480001 */  andi       $t0, $v0, 0x1
    /* 9999C 80098D9C 1500000C */  bnez       $t0, .L80098DD0
    /* 999A0 80098DA0 00442020 */   add       $a0, $v0, $a0 /* handwritten instruction */
    /* 999A4 80098DA4 30880001 */  andi       $t0, $a0, 0x1
    /* 999A8 80098DA8 15000009 */  bnez       $t0, .L80098DD0
    /* 999AC 80098DAC 00000000 */   nop
.L80098DB0:
    /* 999B0 80098DB0 20420002 */  addi       $v0, $v0, 0x2 /* handwritten instruction */
    /* 999B4 80098DB4 1444FFFE */  bne        $v0, $a0, .L80098DB0
    /* 999B8 80098DB8 A440FFFE */   sh        $zero, -0x2($v0)
...
.L80098DD0:
    /* 999D0 80098DD0 20420001 */  addi       $v0, $v0, 0x1 /* handwritten instruction */
    /* 999D4 80098DD4 1444FFFE */  bne        $v0, $a0, .L80098DD0
    /* 999D8 80098DD8 A040FFFF */   sb        $zero, -0x1($v0)
...
endlabel Trouble_RLE_Type2
.size Trouble_RLE_Type2, . - Trouble_RLE_Type2
