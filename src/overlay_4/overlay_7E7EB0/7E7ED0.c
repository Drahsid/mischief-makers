...
//  flags   index   posX    posY    0x110   0xD8    type
    ...
    0x0000, 0x0030, 0x06B8, 0x01E8, 0x3200, 0x0060, 0x0900,
    0x0000, 0x003F, 0x06B8, 0x01EC, 0x0031, 0x0000, 0x090C,
    SPAWNRECORD_END
};
...
//  flags   index   posX    posY    0x110   0xD8    type
    ...
    0x0000, 0x0030, 0x0C20, 0x01B8, 0x3200, 0x0050, ACTORTPYE_OVL2_W5B_PIRATE,
    SPAWNRECORD_END
};
...
void func_801B9D00_7E82D0(void) {
    switch (gStageCinemaState) {
        ...
        case 0x200:
            ...
            func_800282F0(gMarina.posX.whole, gMarina.posY.whole);
