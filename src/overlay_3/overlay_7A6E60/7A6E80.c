...
void func_801B0900_7A6E80(u16 actor_index) {
    switch (gActors[actor_index].state) {
        case 0:
            ...
            // fallthrough
        case 1:
            if ((gActors[actor_index].posX.whole < -0xA8) || (gActors[actor_index].posX.whole >= 0xA9)) {
...
s32 func_801B09B4_7A6F34(u16 arg0, s16 arg1) {
    ...
    for (index = 0x30; index < 0xC0; index++) {
        if ((gActors[index].flags & 2) && (gActors[index].actorType == 0x102) && (arg0 == gActors[index].var_0D8) && (arg1 == gActors[index].posZ.whole)) {
            return 1;
        }
    }
...
void func_801B0A58_7A6FD8(u16 actor_index, s16 position_z) {
    ...
    records = (Overlay_7A6E60_Graphic_Spawn_Record*)gFestivalData_unk_90;

    if (gFestivalData_unk_90 && gFestivalData_unk_90) {
    }
    ...
    right_bound = gScreenPosCurrentX.whole + 0xA8;
    new_var = gScreenPosCurrentX.whole - 0xA8;
...
void func_801B0C20_7A71A0(u16 actor_index) {
    ...
    gFestivalRecords[gFestivalData_currentEvent] = gActors[actor_index].unk_178;
    func_801B0DA0_7A7320(actor_index);
    func_801B2498_7A8A18(actor_index);
    players = gFestivalData_competitors;
    players[0].rank = 4;
    players[1].rank = 1;
    players[2].rank = 2;
    players[3].rank = 3;
...
void func_801B0CEC_7A726C(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_OR(0x31, graphicFlags, 0x811);
    ACTOR_FIXEDADDRESS_OR(0x31, flags, 8);
...
void func_801B0DC8_7A7348(u16 actor_index) {
    ...
    switch (gFestivalData_currentEvent) {
        case 0:
    ...
    if (gFestivalData_competitorCount >= 2) {
        ...
        do {
            ...
            index++;
        } while (index < gFestivalData_competitorCount);
    }
}
...
void func_801B11E0_7A7760(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6E, graphicFlags, 0x200);
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6E, flags, 0xA);
    ...
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6E, posY.whole, 0x54);
...
s32 func_801B12F0_7A7870(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6C, graphicFlags, 0x200);
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6C, flags, 0xA);
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6C, scaleX, 0.9f);
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6C, posX.whole, -0xD);
    ACTOR_FIXEDADDRESS_INDEX_VAR_SET(actor_index, 0x6C, posY.whole, 0x44);
...
void func_801B13F8_7A7978(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_SET(0x69, graphicFlags, 0x851);
    ACTOR_FIXEDADDRESS_SET(0x69, flags, 0xB);
    ...
    ACTOR_FIXEDADDRESS_SET(0x69, posX.whole, 0x37);
    ACTOR_FIXEDADDRESS_SET(0x69, posY.whole, 0x4D);
...
s32 func_801B14A4_7A7A24(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_SET(0x6B, graphicFlags, 0xA00);
    ACTOR_FIXEDADDRESS_SET(0x6B, flags, 0xA);
    ACTOR_FIXEDADDRESS_SET(0x6B, posX.whole, 0x40);
    ACTOR_FIXEDADDRESS_SET(0x6B, posY.whole, (graphic[0] = -0x48));
    ACTOR_FIXEDADDRESS_SET(0x6B, posZ.whole, 0x200);
    ...
    func_8007CD68(0x6A, 0, 0x68, -0x48, (*(s32*)&graphic[0] = graphic[0], 0), 3, 0x3E7);
    ACTOR_FIXEDADDRESS_SET(0x6A, graphicFlags, 0x800);
    ACTOR_FIXEDADDRESS_SET(0x6A, posZ.whole, 0x200);
...
void func_801B1750_7A7CD0(u16 actor_index) {
    ...
    if (gFestivalData_fouls >= 3) {
        ...
        gActors[new_actor_index].posY.whole = 0x40;
        gActors[new_actor_index].posZ.whole = 0xA8;
        gActors[new_actor_index].unk_164 |= 0x1020;
        gFestivalData_eventsPlayed[gFestivalData_currentEvent] = 1;
        Sound_PlaySfx(0x131);
        return;
    }
    ...
    gActors[new_actor_index].posX.whole = 0;
    gActors[new_actor_index].posY.whole = -0x48;
    gActors[new_actor_index].posZ.whole = 0xA8;
    gActors[new_actor_index].scaleX = 1.0f;
    Sound_PlaySfx(0x12F);
}
...
void func_801B195C_7A7EDC(u16 actor_index) {
    ...
    for (index = 0; index < 4; index++) {
        ...
        gActors[new_actor_index].graphicFlags = 0x90D;
        gActors[new_actor_index].flags &= ~4;
        gActors[new_actor_index].graphicIndex = (graphic_data.indices[index] * 2) + 0x2D2;
        gActors[new_actor_index].posX.whole = gActors[actor_index].unk_174 - gScreenPosCurrentX.whole + 0x40;
        gActors[new_actor_index].posY.whole = 0x15E - gScreenPosCurrentY.whole;
        gActors[new_actor_index].posZ.whole = -0xFF;
...
void func_801B1B48_7A80C8(u16 actor_index) {
    ...
    switch (gFestivalData_currentEvent) {
        case 0:
            ...
            gFestivalData_competitorCount = 4;
            break;
        ...
        case 5:
            gActors[actor_index].unk_174 = 0xE20;
            gFestivalData_competitorCount = 2;
            break;
    }

    func_801B0DC8_7A7348(actor_index);
    for (index = 0; (s32)index < (s32)gFestivalData_competitorCount; index++) {
        gFestivalData_competitorIndices[index] = gFestivalData_competitors[index].actorIndex;
    }
...
s16 func_801B1E80_7A8400(u16 actor_index) {
    ...
    count = gFestivalData_competitorCount;
    outer_remaining = (flags = 0);
    if (count > 0) {
        do {
            first_actor = gFestivalData_competitors[outer_remaining].actorIndex;
            if (((s16)gScreenPosCurrentX.whole + gActors[first_actor].posX.whole) >= gActors[actor_index].unk_174) {
                if (gFestivalData_competitors[outer_remaining].rank == 0) {
                    s32 rank_value;

                    rank_value = gActors[actor_index].unk_170;
                    gActors[actor_index].unk_170 = rank_value + 1;
                    gFestivalData_competitors[outer_remaining].rank = rank_value;
                    if (first_actor == 0) {
                        flags |= 1;
                    }
    ...
    while (remaining > 0) {
        sort_indices = gFestivalData_competitorIndices;
        first_actor = 0;
...
DEFAULT_INT func_801B2498_7A8A18(u16 actor_index) {
    u16 index = 0;
    s32 count = gFestivalData_competitorCount;

    if (count > 0) {
        do {
            u16 other_actor = gFestivalData_competitorIndices[index];
            if (other_actor != 0) {
                u16 record_index = gActors[other_actor].unk_16C_u16[1];
                if (gFestivalData_competitors[record_index].rank == 0) {
                    gFestivalData_competitors[record_index].rank = gActors[actor_index].unk_170;
    ...
    gFestivalData_eventsPlayed[gFestivalData_currentEvent] = 1;
    gFestivalData_timeToBeat = gActors[actor_index].unk_178;
    gFestivalData_timeCurrent = gActors[actor_index].unk_17C;
    gFestivalRecords[gFestivalData_currentEvent] = gFestivalData_timeToBeat;
    gFestivalData_eventClearCount++;
}

void func_801B25C4_7A8B44(u16 actor_index) {
    FestivalPlayer* records = gFestivalData_competitors;
...
void func_801B2658_7A8BD8(u16 actor_index) {
    ...
    ACTOR_FIXEDADDRESS_OR(0x32, flags, 8);
...
void func_801B2738_7A8CB8(u16 actor_index) {
    ...
    if (gActors[actor_index].unk_180 != 0) {
        if (gFestivalData_competitors[0].rank == 1) {
            frame = gActiveFrames;
            frame &= 7;
...
s32 func_801B286C_7A8DEC(u16 actor_index) {
    ...
    for (index = 0x70; index < 0x7A; index++) {
        if ((gActors[index].flags & 2) && (gActors[index].actorType == 0x1A03) && (gActors[index].var_158 == 1) && (actor_index == gActors[index].var_154)) {
            return 1;
        }
    }
...
void func_801B2908_7A8E88(u16 actor_index) {
    ...
    min_x = gScreenPosCurrentX.whole - 0x258;
    max_x = gScreenPosCurrentX.whole + 0x258;
...
void func_801B2A88_7A9008(u16 actor_index) {
    if (((gActors[0].posX.whole - gActors[actor_index].posX.whole) > 0 ? (gActors[0].posX.whole - gActors[actor_index].posX.whole) : -(gActors[0].posX.whole - gActors[actor_index].posX.whole)) < 0xB0) {
...
void func_801B2C40_7A91C0(u16 actor_index) {
    if (((gActors[0].posX.whole - gActors[actor_index].posX.whole) > 0 ? (gActors[0].posX.whole - gActors[actor_index].posX.whole) : -(gActors[0].posX.whole - gActors[actor_index].posX.whole)) < 0xA0) {
...
s32 func_801B2F5C_7A94DC(u16 actor_index) {
    ...
    for (index = 0x50; index < 0x60; index++) {
        if ((gActors[index].flags & 2) && (gActors[index].actorType == 0x105) && (actor_index == gActors[index].unk_178)) {
            return 1;
        }
    }
...
void func_801B3180_7A9700(u16 actor_index) {
    ...
    min_x = gScreenPosCurrentX.whole - 0x384;
    max_x = gScreenPosCurrentX.whole + 0x384;
    index = 0;\
    do {
        switch (gFestivalData_currentEvent) {
            case 0:
...
void func_801B3370_7A98F0(u16 actor_index) {
    ...
    if (delta < 0) {
        spawn_x = gScreenPosCurrentX.whole + 0x100;
    }
    else {
        spawn_x = gScreenPosCurrentX.whole - 0x150;
    }
...
void func_801B34D4_7A9A54(u16 actor_index) {
    ...
    switch (actor_state) {
        case 0:
            ...
            gActors[actor_index].unk_178 = gFestivalRecords[gFestivalData_currentEvent];
            gFestivalData_isTimeBeat = 0;
        ...
        case 0x30:
            if ((0x220 - gScreenPosCurrentX.whole) < gActors[0].posX.whole) {
                gActors[actor_index].state = 0x60;
            }
            else {
                if (--gActors[actor_index].var_150 <= 0) {
                    func_801B14A4_7A7A24(actor_index);
                    gFestivalData_eventState = 0x40;
        ...
        case 0x50:
            if (gFestivalData_currentEvent != 5) {
            ...
            D_800BE544 = gFestivalData_competitorIndices[0];
        ...
        case 0x60:
            ...
            gActors[0x31].posZ.whole = 0xA7;
            gActors[actor_index].var_150 = 0x41;
            gActors[actor_index].state++;
            break;

        case 0x61:
            gActors[0].graphicFlags |= 0x800;
            gActors[0].unk_188 = 0;
            gActors[0].posZ.whole = 0xA8;
            if (--gActors[actor_index].var_150 <= 0) {
                gActors[actor_index].state++;
    ...
    if (gFestivalData_currentEvent == 5) {
        func_801B0A58_7A6FD8(actor_index, -0x60);
    }
}
...
void func_801B3BCC_7AA14C(u16 actor_index) {
    ...
    switch (gFestivalData_currentEvent) {
        case 0:
            gActors[actor_index].unk_118 = D_801B55D4_7ABB54[(gFestivalData_competitors[gActors[actor_index].unk_16C].rand * 8) + gActors[actor_index].unk_170] + D_801B5760_7ABCE0[gFestivalData_unk_9A];
            break;

        case 1:
            gActors[actor_index].unk_118 = D_801B5658_7ABBD8[(gFestivalData_competitors[gActors[actor_index].unk_16C].rand * 8) + gActors[actor_index].unk_170] + D_801B5760_7ABCE0[gFestivalData_unk_9A];
            break;

        case 2:
            gActors[actor_index].unk_118 = D_801B56DC_7ABC5C[(gFestivalData_competitors[gActors[actor_index].unk_16C].rand * 8) + gActors[actor_index].unk_170] + D_801B5760_7ABCE0[gFestivalData_unk_9A];
            break;
    }
...
void func_801B3E9C_7AA41C(u16 actor_index) {
    ...
    switch (gActors[actor_index].state) {
        ...
        case 0x61:
            ...
            if (gFestivalData_eventState != gActors[actor_index].unk_174_u16[1]) {
                gActors[actor_index].unk_174 = gFestivalData_eventState;
            }
            ...
            switch (gActors[actor_index].unk_174_u16[1]) {
                ...
                case 0x40:
                    switch (gActors[actor_index].unk_174_u16[0]) {
                        ...
                        case 1:
                            if (1 == gFestivalData_competitors[gActors[actor_index].unk_16C].rank) {
        ...
        case 0xA1:
            ...
            if ((gFestivalData_competitors[gActors[actor_index].unk_16C_u32].actor_unk_174 + 0x30) < gActors[actor_index].unk_17C) {
    ...
    gActors[actor_index].flags = gActors[actor_index].flags & 0xFFFFE87F;
}
...
void func_801B41F4_7AA774(u16 actor_index) {
    ...
    actor->unk_170 = index;
    actor->unk_118 = D_801B5788_7ABD08[(gFestivalData_competitors[actor->unk_16C].rand * 8) + index] + D_801B580C_7ABD8C[gFestivalData_unk_9A];
}
...
void func_801B4298_7AA818(u16 actor_index) {
    ...
    switch (gActors[actor_index].state) {
        ...
        case 0x61:
            ...
            switch (gActors[actor_index].unk_174_u16[1]) {
                ...
                case 0x30:
                    gActors[actor_index].graphicList = D_800E176C;
                    gActors[actor_index].graphicTimer = (u16)1;
                    gActors[actor_index].unk_184_s16[0] = gFestivalData_competitors[gActors[actor_index].unk_16C].actor_unk_174 + 0x60;
                    break;
                ...
                case 0x40:
                    switch (gActors[actor_index].unk_174_u16[0]) {
                        ...
                        case 1:
                            if (gFestivalData_competitors[gActors[actor_index].unk_16C].rank == 1) {
                                gActors[actor_index].unk_120 = 0.0f;
                                gActors[actor_index].unk_11C = (f32)FIXED_UNIT(5.0);
                                gActors[actor_index].unk_124 = (f32)(Rand() & 1);
                                gActors[actor_index].state = 0x120;
        ...
        case 0xA1:
            ...
            func_800734C4(actor_index, 0x10);
            if (gActors[actor_index].unk_17C >= (gFestivalData_competitors[gActors[actor_index].unk_16C].actor_unk_174 + 0x20)) {
    ...
    gActors[actor_index].flags &= 0xFFFFE87F;
}
...
void func_801B4D68_7AB2E8(u16 actor_index) {
    if (gActors[actor_index].state == 0) {
        ...
        gActors[actor_index].posY.whole = -0x28;
        ...
        if (!(gActors[actor_index].var_0D8 & 1)) {
            if ((gActors[actor_index].posX.whole < -0x160) || (gActors[actor_index].posX.whole >= 0x110)) {
                gActors[actor_index].flags = 0;
            }
        }
    }
