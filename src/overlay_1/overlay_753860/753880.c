...
void func_8019B314_753A94(u16 actor_index) {
    if (gActors[actor_index].state != 0) {
        ...
        gActors[actor_index + 6].unk_180 = gActors[actor_index].posX.whole + gScreenPosCurrentX;
        gActors[actor_index + 7].unk_180 = gActors[actor_index].posY.whole + gScreenPosCurrentY;
