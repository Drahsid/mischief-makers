...
s16 D_8019B850_753FD0[] = {
    0x0806, 0x0400, 0x0013, 0x0000, 0x0000, 0x0020, 0x0804, 0x8770,
    0x0013, 0x0000, 0x0000, 0x0020, 0x0812, 0x87B0, 0x0013, 0x0000,
    0x0000, 0x0020, 0x0808, 0x8440, 0x0014, 0x0000, 0x0000, 0x0020,
    0x0808, 0x8440, 0x0000, 0x0000, 0x0000, 0x0020, 0x080A, 0x8490,
    0x0012, 0x0000, 0x0000, 0x0020, 0x080C, 0x8400, 0x0005, 0x0000,
    0x0000, 0x0020, 0x0800, 0x8400, 0x0004, 0x0000, 0x0000, 0x0020,
    0x0802, 0x8400, 0x0003, 0x0000, 0x0000, 0x0020, 0x080C, 0x8400,
    0x0002, 0x0000, 0x0000, 0x0020, 0x0800, 0x8400, 0x0001, 0x0000,
    0x0000, 0x0020, 0x0802, 0x8400, 0x0000, 0x0000,
};
...
void func_8019B100_753880(u16 actor_index) {
    gActors[actor_index].velocityX.raw = Math_ApproachS32(gActors[actor_index].velocityX.raw, 0, gActors[actor_index + 1].unk_12C * FIXED_UNIT(8.0/256));
