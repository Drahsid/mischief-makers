...
void func_8008D39C(u16 actor_index) {
    gActors[actor_index].unk_184 = Math_ApproachS32(gActors[actor_index].unk_184, 0, FIXED_UNIT(1.0/16));
...
void func_8008DA4C(u16 actor_index) {
    ...
    if ((gButtonHold & gButton_DRight) && (gActors[actor_index].velocityX.raw < 0)) {
        gActors[actor_index].unk_184 = Math_ApproachS32(gActors[actor_index].unk_184, FIXED_UNIT(1.0), FIXED_UNIT(1.0/8));
    }
...
void func_8008E1A0(u16 actor_index) {
    ...
    case 0x10:
        ...
        break;
    case 0x70:
        gActors[actor_index].unk_184 = Math_ApproachS32(gActors[actor_index].unk_184, 0, FIXED_UNIT(1.0/8));
