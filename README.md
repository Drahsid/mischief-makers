...
[![Total Matching]](https://decomp.dev/Drahsid/mischief-makers)
[![Main Segment]](https://decomp.dev/Drahsid/mischief-makers?category=segment_main)
[![Overlays]](https://decomp.dev/Drahsid/mischief-makers?category=overlays)

[Total Matching]: https://decomp.dev/Drahsid/mischief-makers.svg?mode=shield&label=us1%20total&measure=matched_code_percent
[Main Segment]: https://decomp.dev/Drahsid/mischief-makers.svg?mode=shield&label=us1%20main&measure=matched_code_percent&category=segment_main
[Overlays]: https://decomp.dev/Drahsid/mischief-makers.svg?mode=shield&label=us1%20overlays&measure=matched_code_percent&category=overlays
...
- `tools/progress.py`: generate progress report. `[-v version]`, `[-u]`, `[-s]`, `[-r]`
