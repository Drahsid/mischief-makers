...
void func_80775610(uint16_t index) {
    ...
    if ((gActors[index].flag & ACTOR_FLAG_FLIPPED && ((gButtonHold & gButton_DRight))) || (gActors[index].flag & ACTOR_FLAG_FLIPPED == 0 && ((gButtonHold & gButton_DLeft)))) {
...
void func_80775B10(uint16_t index) {
    ...
    if ((gActors[index].unk_0x11C + gActors[index].unk_0x118) >= 32.0) {
        SFX_ActorPanX(0x53, index);
    }
    if (gActors[index].unk_0x118 < D_801B0080) {
        gActors[index].unk_0x118 = (float)D_801B0088;
    }
    gActors[index].unk_0x118 = func_80029860(gActors[index].unk_0x118, 1.5f, 0.02f);
    func_801A76DC(index);
...
void func_80775FF8(uint16_t index1) {
    ...
    if (index0) {
        ...
        gActors[index0].ScaleX = D_801B00A0;
        gActors[index0].ScaleY = D_801B00A0;
...
void func_80777EA8(uint16_t index) {
    if (gActors[index].unk_0xD0_h == 0) {
        ...
        gActors[index].vel.x_w = 0xFFFB0000;
        gActors[index].vel.y_w = 0x30000;
        gActors[index].unk_0xD8 &= 0xFFF7;
        gActors[index].flag &= ~(ACTOR_FLAG_UNK2 | ACTOR_FLAG_UNK4); //-0x21;
        SFX_ActorPanX(0x9D, index);
    }
    else {
...
void func_8077B908(uint16_t x){}

#pragma GLOBAL_ASM("asm/nonmatchings/7754F0/func_8077B910.s")

void func_8077BA74(uint16_t index){
...
void func_8077BF40(uint16_t x){}

#pragma GLOBAL_ASM("asm/nonmatchings/7754F0/func_8077BF48.s")

void func_8077C050(uint16_t x){}

#pragma GLOBAL_ASM("asm/nonmatchings/7754F0/func_8077C058.s")

void func_8077CF18(uint16_t index){
    gActors[index].unk_0x98&= ~0x00200600;
}

void func_8077C240(uint16_t x){}

void func_8077C248(uint16_t x){}
...
void func_8077D69C(uint16_t x){}

void func_8077D6A4(uint16_t index){
    ...
    gActors[index].col.r=0x80;
    gActors[index].ScaleX=8.0;
    gActors[index].RotateY=45.0;
}
