...
// BUG: inconsistent prototype! has 7th arg - is used in func, but isn't loaded in many calls.
...
#define ALPHA_CMD_UNK15 (1U << 15U) // bit 15 determines presence of command bits
