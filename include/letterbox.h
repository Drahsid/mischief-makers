...
//dyanmically frame the shot between Marina and a boss or other point of interest.

//these should be used with the global value "gLetterboxMode"
enum LetterboxTypes{
    LETTERBOX_DEFAULT, //standard letterbox for majority of game
    LETTERBOX_HORIZONTAL, //top and bottom borders get narrower as PoI distance grows
    LETTERBOX_VERTICAL, //left and right borders get narrower as PoI distance grows
};
