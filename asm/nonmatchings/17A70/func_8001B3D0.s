...
/* 1BFD8 8001B3D8 3C18800C */  lui        $t8, %hi(gSaveSlotIndex)
/* 1BFDC 8001B3DC 93185008 */  lbu        $t8, %lo(gSaveSlotIndex)($t8)
...
/* 1BFF4 8001B3F4 3C018017 */  lui        $at, %hi(GameSave_RedGems)
/* 1BFF8 8001B3F8 0018C840 */  sll        $t9, $t8, 1
/* 1BFFC 8001B3FC AFBF0014 */  sw         $ra, 0x14($sp)
/* 1C000 8001B400 00390821 */  addu       $at, $at, $t9
/* 1C004 8001B404 0C006C91 */  jal        YellowGem_Count
/* 1C008 8001B408 A42F1AD0 */   sh        $t7, %lo(GameSave_RedGems)($at)
/* 1C00C 8001B40C 3C03800C */  lui        $v1, %hi(gSaveSlotIndex)
/* 1C010 8001B410 90635008 */  lbu        $v1, %lo(gSaveSlotIndex)($v1)
/* 1C014 8001B414 3C018017 */  lui        $at, %hi(GameSave_YellowGems)
/* 1C018 8001B418 00034040 */  sll        $t0, $v1, 1
/* 1C01C 8001B41C 00280821 */  addu       $at, $at, $t0
/* 1C020 8001B420 A4221AD4 */  sh         $v0, %lo(GameSave_YellowGems)($at)
