...
/* A87FC 800A7BFC 3C0E8018 */  lui        $t6, %hi(__CartRomHandle+0xC)
/* A8800 800A7C00 8DCE573C */  lw         $t6, %lo(__CartRomHandle+0xC)($t6)
/* A8804 800A7C04 3C01B000 */  lui        $at, 0xb000
/* A8808 800A7C08 15C10004 */  bne        $t6, $at, .L800A7C1C
/* A880C 800A7C0C 00000000 */   nop
/* A8810 800A7C10 3C028018 */  lui        $v0, %hi(__CartRomHandle)
/* A8814 800A7C14 10000035 */  b          .L800A7CEC
/* A8818 800A7C18 24425730 */   addiu     $v0, $v0, %lo(__CartRomHandle)
.L800A7C1C:
/* A881C 800A7C1C 3C018018 */  lui        $at, %hi(__CartRomHandle+0x4)
/* A8820 800A7C20 A0205734 */  sb         $zero, %lo(__CartRomHandle+0x4)($at)
/* A8824 800A7C24 3C0FB000 */  lui        $t7, 0xb000
/* A8828 800A7C28 3C018018 */  lui        $at, %hi(__CartRomHandle+0xC)
/* A882C 800A7C2C AC2F573C */  sw         $t7, %lo(__CartRomHandle+0xC)($at)
...
/* A8840 800A7C40 3C018018 */  lui        $at, %hi(__CartRomHandle+0x5)
/* A8844 800A7C44 331900FF */  andi       $t9, $t8, 0xff
/* A8848 800A7C48 A0395735 */  sb         $t9, %lo(__CartRomHandle+0x5)($at)
/* A884C 800A7C4C 8FA8001C */  lw         $t0, 0x1c($sp)
/* A8850 800A7C50 3C018018 */  lui        $at, %hi(__CartRomHandle+0x8)
/* A8854 800A7C54 00084A02 */  srl        $t1, $t0, 8
/* A8858 800A7C58 312A00FF */  andi       $t2, $t1, 0xff
/* A885C 800A7C5C A02A5738 */  sb         $t2, %lo(__CartRomHandle+0x8)($at)
/* A8860 800A7C60 8FAB001C */  lw         $t3, 0x1c($sp)
/* A8864 800A7C64 3C018018 */  lui        $at, %hi(__CartRomHandle+0x6)
/* A8868 800A7C68 000B6402 */  srl        $t4, $t3, 0x10
/* A886C 800A7C6C 318D000F */  andi       $t5, $t4, 0xf
/* A8870 800A7C70 A02D5736 */  sb         $t5, %lo(__CartRomHandle+0x6)($at)
/* A8874 800A7C74 8FAE001C */  lw         $t6, 0x1c($sp)
/* A8878 800A7C78 3C018018 */  lui        $at, %hi(__CartRomHandle+0x7)
/* A887C 800A7C7C 000E7D02 */  srl        $t7, $t6, 0x14
/* A8880 800A7C80 31F8000F */  andi       $t8, $t7, 0xf
/* A8884 800A7C84 A0385737 */  sb         $t8, %lo(__CartRomHandle+0x7)($at)
/* A8888 800A7C88 3C018018 */  lui        $at, %hi(__CartRomHandle+0x9)
/* A888C 800A7C8C A0205739 */  sb         $zero, %lo(__CartRomHandle+0x9)($at)
/* A8890 800A7C90 3C048018 */  lui        $a0, %hi(__CartRomHandle)
/* A8894 800A7C94 24845730 */  addiu      $a0, $a0, %lo(__CartRomHandle)
...
/* A88B8 800A7CB8 3C018018 */  lui        $at, %hi(__CartRomHandle)
/* A88BC 800A7CBC AC395730 */  sw         $t9, %lo(__CartRomHandle)($at)
/* A88C0 800A7CC0 3C088018 */  lui        $t0, %hi(__CartRomHandle)
/* A88C4 800A7CC4 25085730 */  addiu      $t0, $t0, %lo(__CartRomHandle)
...
/* A88D8 800A7CD8 3C028018 */  lui        $v0, %hi(__CartRomHandle)
/* A88DC 800A7CDC 10000003 */  b          .L800A7CEC
/* A88E0 800A7CE0 24425730 */   addiu     $v0, $v0, %lo(__CartRomHandle)
