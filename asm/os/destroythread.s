...
/* B6028 800B5428 0C0297A4 */  jal        __osDisableInt
...
/* B6040 800B5440 3C0F800F */  lui        $t7, %hi(__osRunningThread)
/* B6044 800B5444 8DEFA610 */  lw         $t7, %lo(__osRunningThread)($t7)
...
/* B606C 800B546C 0C029C84 */  jal        __osDequeueThread
/* B6070 800B5470 01002825 */   or        $a1, $t0, $zero
.L800B5474:
/* B6074 800B5474 3C09800F */  lui        $t1, %hi(__osActiveQueue)
/* B6078 800B5478 8D29A60C */  lw         $t1, %lo(__osActiveQueue)($t1)
/* B607C 800B547C 8FAA0038 */  lw         $t2, 0x38($sp)
/* B6080 800B5480 152A0007 */  bne        $t1, $t2, .L800B54A0
/* B6084 800B5484 00000000 */   nop
/* B6088 800B5488 3C0B800F */  lui        $t3, %hi(__osActiveQueue)
/* B608C 800B548C 8D6BA60C */  lw         $t3, %lo(__osActiveQueue)($t3)
/* B6090 800B5490 3C01800F */  lui        $at, %hi(__osActiveQueue)
/* B6094 800B5494 8D6C000C */  lw         $t4, 0xc($t3)
/* B6098 800B5498 10000012 */  b          .L800B54E4
/* B609C 800B549C AC2CA60C */   sw        $t4, %lo(__osActiveQueue)($at)
.L800B54A0:
/* B60A0 800B54A0 3C11800F */  lui        $s1, %hi(__osActiveQueue)
/* B60A4 800B54A4 8E31A60C */  lw         $s1, %lo(__osActiveQueue)($s1)
...
.L800B54E4:
/* B60E4 800B54E4 3C19800F */  lui        $t9, %hi(__osRunningThread)
/* B60E8 800B54E8 8F39A610 */  lw         $t9, %lo(__osRunningThread)($t9)
/* B60EC 800B54EC 8FB80038 */  lw         $t8, 0x38($sp)
/* B60F0 800B54F0 17190003 */  bne        $t8, $t9, .L800B5500
/* B60F4 800B54F4 00000000 */   nop
/* B60F8 800B54F8 0C029B00 */  jal        __osDispatchThread
/* B60FC 800B54FC 00000000 */   nop
.L800B5500:
/* B6100 800B5500 0C0297AC */  jal        __osRestoreInt
