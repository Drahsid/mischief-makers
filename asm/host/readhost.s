...
/* B5528 800B4928 3C0E800F */  lui        $t6, %hi(readhost_data_0000)
/* B552C 800B492C 8DCEAAA0 */  lw         $t6, %lo(readhost_data_0000)($t6)
/* B5530 800B4930 15C0000F */  bnez       $t6, .L800B4970
/* B5534 800B4934 00000000 */   nop
/* B5538 800B4938 3C048019 */  lui        $a0, %hi(readhost_bss_0000)
/* B553C 800B493C 3C058019 */  lui        $a1, %hi(readhost_bss_0018)
/* B5540 800B4940 24A5A728 */  addiu      $a1, $a1, %lo(readhost_bss_0018)
/* B5544 800B4944 2484A710 */  addiu      $a0, $a0, %lo(readhost_bss_0000)
/* B5548 800B4948 0C026994 */  jal        osCreateMesgQueue
/* B554C 800B494C 24060001 */   addiu     $a2, $zero, 1
/* B5550 800B4950 3C058019 */  lui        $a1, %hi(readhost_bss_0000)
/* B5554 800B4954 24A5A710 */  addiu      $a1, $a1, %lo(readhost_bss_0000)
/* B5558 800B4958 2404000F */  addiu      $a0, $zero, 0xf
/* B555C 800B495C 0C0269BC */  jal        osSetEventMesg
/* B5560 800B4960 00003025 */   or        $a2, $zero, $zero
/* B5564 800B4964 240F0001 */  addiu      $t7, $zero, 1
/* B5568 800B4968 3C01800F */  lui        $at, %hi(readhost_data_0000)
/* B556C 800B496C AC2FAAA0 */  sw         $t7, %lo(readhost_data_0000)($at)
.L800B4970:
/* B5570 800B4970 8FB80030 */  lw         $t8, 0x30($sp)
/* B5574 800B4974 3C018019 */  lui        $at, %hi(__osRdb_Read_Data_Buf)
/* B5578 800B4978 AC38A72C */  sw         $t8, %lo(__osRdb_Read_Data_Buf)($at)
/* B557C 800B497C 8FB90034 */  lw         $t9, 0x34($sp)
/* B5580 800B4980 3C018019 */  lui        $at, %hi(__osRdb_Read_Data_Ct)
/* B5584 800B4984 AC39A730 */  sw         $t9, %lo(__osRdb_Read_Data_Ct)($at)
...
/* B559C 800B499C 0C02A254 */  jal        __osRdbSend
...
.L800B49C0:
/* B55C0 800B49C0 3C048019 */  lui        $a0, %hi(readhost_bss_0000)
/* B55C4 800B49C4 2484A710 */  addiu      $a0, $a0, %lo(readhost_bss_0000)
/* B55C8 800B49C8 00002825 */  or         $a1, $zero, $zero
/* B55CC 800B49CC 0C026B44 */  jal        osRecvMesg
