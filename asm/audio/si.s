...
/* 9C630 8009BA30 3C0E800F */  lui        $t6, %hi(alGlobals)
/* 9C634 8009BA34 8DCEA520 */  lw         $t6, %lo(alGlobals)($t6)
/* 9C638 8009BA38 15C00008 */  bnez       $t6, .L8009BA5C
/* 9C63C 8009BA3C 00000000 */   nop
/* 9C640 8009BA40 8FAF0018 */  lw         $t7, 0x18($sp)
/* 9C644 8009BA44 3C01800F */  lui        $at, %hi(alGlobals)
/* 9C648 8009BA48 AC2FA520 */  sw         $t7, %lo(alGlobals)($at)
/* 9C64C 8009BA4C 3C04800F */  lui        $a0, %hi(alGlobals)
/* 9C650 8009BA50 8C84A520 */  lw         $a0, %lo(alGlobals)($a0)
/* 9C654 8009BA54 0C027950 */  jal        alSynNew
...
/* 9C680 8009BA80 3C0E800F */  lui        $t6, %hi(alGlobals)
/* 9C684 8009BA84 8DCEA520 */  lw         $t6, %lo(alGlobals)($t6)
/* 9C688 8009BA88 11C00005 */  beqz       $t6, .L8009BAA0
/* 9C68C 8009BA8C 00000000 */   nop
/* 9C690 8009BA90 0C02AC8C */  jal        alSynDelete
/* 9C694 8009BA94 8FA40018 */   lw        $a0, 0x18($sp)
/* 9C698 8009BA98 3C01800F */  lui        $at, %hi(alGlobals)
/* 9C69C 8009BA9C AC20A520 */  sw         $zero, %lo(alGlobals)($at)
.L8009BAA0:
